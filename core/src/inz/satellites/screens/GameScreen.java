...
import inz.satellites.engine.ControlHandler;
import inz.satellites.engine.Satellites;
import inz.satellites.utils.Config;
import inz.satellites.objects.Satellite;
import inz.satellites.engine.World;
import inz.satellites.engine.RenderMenager;
...
public class GameScreen extends AbstractScreen{
     ...
     * Renderer.
     */
    private RenderMenager renderer;
    ...
    public GameScreen(Satellites game){
        ...
        renderer = new RenderMenager(world,getBatch(),getSkin());
        ...
        gameInputHandler = new ControlHandler(world,menuWindow).getInputMultiplexer();
    ...
    private void hideMenu(){
        menuWindow.cancel();
        menuWindow.removeActor(ControlHandler.godmodeButton);
        ControlHandler.godemodeButtonAdded = false;
        menu = false;
    }
